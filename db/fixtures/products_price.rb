...
#   - Product(15): エアガン base 600,000 (税込)
price_map_by_product = {
  ...
  7 => { 
    lv["アジアビジネストラスト"] => { price: 143_000, rate: 0 }, 
    lv["総代理店"] => { price: 143_000, rate: 20 }, 
    lv["代理店"] => { price: 143_000, rate: 15 }, 
    lv["アドバイザー"] => { price: 143_000, rate: 10 }, 
    # アドバイザー認定前は購入不可のため価格設定なし
    lv["サポーター"] => { price: 143_000, rate: 5 }, 
    lv["クリニック"] => { price: 143_000, rate: 0 }, 
    lv["サロン"] => { price: 143_000, rate: 0 }, 
    lv["お客様"] => { price: 143_000, rate: 0 } 
  },
  8 => { 
    lv["アジアビジネストラスト"] => { price: 143_000, rate: 0 }, 
    lv["総代理店"] => { price: 143_000, rate: 20 }, 
  ...
  9 => { 
    lv["アジアビジネストラスト"] => { price: 121_000, rate: 0 }, 
    lv["総代理店"] => { price: 121_000, rate: 20 }, 
    lv["代理店"] => { price: 121_000, rate: 15 }, 
    lv["アドバイザー"] => { price: 121_000, rate: 10 }, 
    # アドバイザー認定前は購入不可のため価格設定なし
    lv["サポーター"] => { price: 121_000, rate: 5 }, 
    lv["クリニック"] => { price: 121_000, rate: 0 }, 
    lv["サロン"] => { price: 121_000, rate: 0 }, 
    lv["お客様"] => { price: 121_000, rate: 0 } 
  },
  10 => { 
    lv["アジアビジネストラスト"] => { price: 121_000, rate: 0 }, 
    lv["総代理店"] => { price: 121_000, rate: 20 }, 
  ...
  15 => { 
    lv["アジアビジネストラスト"] => { price: 600_000, rate: 0 }, 
    lv["総代理店"] => { price: 600_000, rate: 20 }, 
    lv["代理店"] => { price: 600_000, rate: 15 }, 
    lv["アドバイザー"] => { price: 600_000, rate: 10 }, 
    # アドバイザー認定前は購入不可のため価格設定なし
    lv["サポーター"] => { price: 600_000, rate: 5 }, 
    lv["クリニック"] => { price: 600_000, rate: 0 }, 
    lv["サロン"] => { price: 600_000, rate: 0 }, 
    lv["お客様"] => { price: 600_000, rate: 0 } 
  }
}
...
puts "⚠️  注意: アドバイザー認定前レベルは商品購入不可のため価格設定を除外しています"